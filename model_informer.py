...
class DataEmbedding(nn.Module):
    def __init__(self, c_in, d_model, embed_type='fixed', freq='h', dropout=0.1):
        ...
        self.position_embedding = PositionalEncoder(d_model)
...
class EncoderLayer(nn.Module):
    def __init__(self, attention, d_model, d_ff=None, dropout=0.1, activation="relu"):
        ...
        self.activation = nn.ReLU(True) if activation == "relu" else nn.ReLU(True)
...
if __name__ == '__main__':
    model = Informer(4**4, 1, 2048, d_model=128, n_heads=8, e_layers=6, d_ff=128, dropout=0.6).cuda()
    input = torch.randint(4**4, (1, 500-3)).cuda()
    output = model(input)
    print(output.shape)